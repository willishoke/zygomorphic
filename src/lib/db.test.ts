...
describe('cascade delete', () => {
  it('deleting a node removes its edges and comments', async () => {
    ...
    await insertComment({
      ...
      author: 'human', created_at: now, expires_at: null, score: 0, updated_at: null, deleted_at: null,
    });
...
describe('comments', () => {
  ...
  it('filters expired comments', async () => {
    const expired: Comment = {
      ...
      expires_at: new Date(Date.now() - 60_000).toISOString(), score: 0, updated_at: null, deleted_at: null,
    };
